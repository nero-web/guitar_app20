...
import myLogo from '../assets/orlogo.PNG'
...
const Navbar = () => {
  ...
  return (
    <div className='bg-slate-50 flex w-full justify-between items-center h-20 px-20 z-10 text-black relative'>
      <div>
        <img className='z-10 w-20 h-20' src={myLogo} alt='myLogo'/>
      </div>
