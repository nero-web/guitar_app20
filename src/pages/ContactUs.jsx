      ...
      <div className='px-5 max-w-[1260px] w-full mx-auto min-h-[20px]'>
        <div className='flex md:flex-row justify-between items-start xsm:flex-col gap-5'>
          <div className='max-w-[305px] w-full '>
            ...
            <a
              href='mailto:chris@guitarmalade.com'
              class='color-black underline mb-4'>
              chris@guitarmalade.com
            </a>
          ...
          <div className='max-w-[630px] w-full '>
            ...
            <div>
                <form autoComplete="off" action="" ref={form} method="send" onSubmit={sendEmail}>
                    ...
                    <input name="subject _title" type="text" required placeholder="Subject (Optional)" className="w-full min-h-[40px] text-gray-700 bg-white rounded mb-4 h-[40px] px-2 py-3 text-base leading-7 block outline-blue-500 border border-[#e6e7e8]" />
                    <textarea name="message" type="text" maxLength={5000} required placeholder="Message ...." className="w-full h-[auto] text-gray-700 bg-white rounded mb-4 px-2 py-3 text-base leading-7 block outline-blue-500 border border-[#e6e7e8]"></textarea>
